...
def add_school_trophy(ref_point, drawing, name, year):
    ...
    x,y = ref_point
    text_align('Sydney Boys High School',mid_trophy+x,120+y,4.7,drawing)
    text_align('Student Award Scheme',mid_trophy+x,110+y,5.7,drawing)
    ...
    text_align(name,45+x,34.5+y,4.5,drawing, style = 'STANDARD')
